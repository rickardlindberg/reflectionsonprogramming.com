...
Because I've never felt this kind of beauty in my object oriented code, I suspect that it is the way functional languages allow you to combine pieces that make them beautiful.

If you want to get at closer look at the source code or look at other implementations, it is up on "github":https://github.com/rickardlindberg/brainfuck.
