...
_I never used the tool that I describe in this post. I guess it was because I could run my tests as fast from Vim. However, after watching Bret Victor's amazing talk "Inventing on Principle":http://vimeo.com/36579366, I was inspired to build a tool like this again. It should be able to visualize more aspects of your code other than the tests passing or failing. The goal should be to give you quicker feedback on your changes. I shall write more about my attempts at building this tool in the future._
