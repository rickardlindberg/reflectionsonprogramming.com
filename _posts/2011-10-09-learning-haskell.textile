...
h2. Haskell's syntax is intimidating
...
Perhaps this is a false sense of confidence. I don't yet know. But for sure I can skip writing some types of tests because the compiler will check things for me.

h2. The size of the steps
...
When this happened I thought about "Structure and Interpretation of Computer Programs":http://mitpress.mit.edu/sicp/. In particular how they described that the best way to solve a complex problem is to design a language in which that problem is trivial to solve.

When reading the code for the parser, I can focus on one layer at a time. Compared to OOP where you have a web of objects communicating with each other, it feels like the layered structure is easier to understand. The different structures feels like the picture below:

!/images/fp_oop_structure.png(Structure of FP and OOP.)!

h2. Re-use

The reuse of code feels different in Haskell than in OOP. Firstly I think it is because you design languages build from primitives. Secondly I think it is because you write pure functions with no side effects.

h2. Summary

I had a very nice weekend getting to know Haskell a bit better and I'm looking forward to seeing it again.
