...
I've experimented with different solutions: both to see how different approaches feel like and also to see how different solutions affects performance.

Today I wrote a version that I find so beautiful and elegant that I must share it. It is my fifth implementation, and it is inspired by ideas that raek presented to me during and after a workshop.

h2. Brainfuck

If you don't know what Brainfuck is or how it works, go read on Wikipedia. I will not explain it here.
...
To make it easier to work with the data tape, we have these general helper functions which will work no matter what implementation of the typeclass we use:
...
If you want to experience it for yourself, the source code is up on github.
